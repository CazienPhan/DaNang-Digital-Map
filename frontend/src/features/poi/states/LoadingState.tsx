...
export const LoadingState: React.FC<LoadingStateProps> = React.memo(({
    ...
    const content = (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '12px', padding: '24px', height: '100%' }}>
    ...
    if (isSecondary) {
      return (
        <div className="poi-detail-card secondary-card poi-loading-card">
          {content}
        </div>
      );
    }
